...
const (
	...
	EXIT_PIPING        ExitCode = 13 // Returned when IO to the *user* (e.g. stdout) fails.  (*Not* when disk or db IO fails.)  (We use the same magic int as SIGPIPE to be cute.)
)
